        ...
        <div className="coffee-club">
          <div className="flex items-center gap-x-6">
            ...
            <div className="flex flex-col gap-y-2">
              <h3 className="xl:text-5xl lg:text-4xl md:text-3xl sm:text-4xl text-2xl font-MorrabbaBold">
                کافی کلاب
              </h3>
              <span className="lg:w-auto md:w-45 xl:text-2xl lg:text-xl md:text-base sm:text-lg font-Morrabba tracking-[0%]">
                میدونستی میتونی با امتیاز هات قهوه بگیری ؟
              </span>
            </div>
          </div>
          <div className="flex items-center md:justify-baseline justify-between xl:gap-x-27.5 lg:gap-x-24 md:gap-x-10">
            <div className="flex items-center lg:gap-x-5 xs:gap-x-3 gap-x-1 text-emerald-600 xl:*:size-24 lg:*:size-22 xs:*:size-18 *:size-16">
              <div className="pt-4 bg-white rounded-2xl text-center">
                <svg
                  className="lg:size-10 size-6 mx-auto"
                  viewBox="0 0 40 36"
                  fill="none"
                ...
                <span className="lg:text-base xs:text-sm text-xs">
                  جایزه ها
                </span>
              </div>
              <div className="pt-4 bg-white rounded-2xl text-center">
            ...
            <div>
              <p className="xs:text-3xl text-xl font-DanaDemibold md:leading-7 leading-2.5">
                542
              </p>
              <span className="lg:inline-block hidden text-sm mt-1">
                امتیـــــــاز شما
              </span>
              <span className="lg:hidden inline-block text-sm mt-1">
                امتیــــاز شما
              </span>
              <a href="#" className="coffee-club-btn rounded-full">
